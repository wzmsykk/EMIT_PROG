...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_bname = QtWidgets.QLabel(self.widget)
        self.label_bname.setObjectName("label_bname")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.label_bname)
        self.lineEdit_binput = QtWidgets.QLineEdit(self.widget)
        self.lineEdit_binput.setObjectName("lineEdit_binput")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.lineEdit_binput)
        ...
        self.lineEdit_sigma2 = QtWidgets.QLineEdit(self.widget)
        self.lineEdit_sigma2.setObjectName("lineEdit_sigma2")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.lineEdit_sigma2)
        self.label_4 = QtWidgets.QLabel(self.widget)
        self.label_4.setObjectName("label_4")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.label_4)
        self.lineEdit_energy = QtWidgets.QLineEdit(self.widget)
        self.lineEdit_energy.setObjectName("lineEdit_energy")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.lineEdit_energy)
        self.label_compname = QtWidgets.QLabel(self.widget)
        self.label_compname.setMinimumSize(QtCore.QSize(168, 0))
        self.label_compname.setObjectName("label_compname")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.label_compname)
        self.lineEdit_l = QtWidgets.QLineEdit(self.widget)
        self.lineEdit_l.setObjectName("lineEdit_l")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.lineEdit_l)
        self.label_11 = QtWidgets.QLabel(self.widget)
        self.label_11.setObjectName("label_11")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.label_11)
        self.lineEdit_ld = QtWidgets.QLineEdit(self.widget)
        self.lineEdit_ld.setObjectName("lineEdit_ld")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.lineEdit_ld)
        ...
        self.pushButton_calck = QtWidgets.QPushButton(self.frame_4)
        self.pushButton_calck.setObjectName("pushButton_calck")
        self.gridLayout.addWidget(self.pushButton_calck, 2, 1, 1, 1)
        ...
        self.frame_fig.setMinimumSize(QtCore.QSize(500, 400))
        ...
        self.radioButton_kvssigma2 = QtWidgets.QRadioButton(self.groupBox_3)
        font = QtGui.QFont()
        font.setPointSize(14)
        self.radioButton_kvssigma2.setFont(font)
        self.radioButton_kvssigma2.setChecked(True)
        self.radioButton_kvssigma2.setObjectName("radioButton_kvssigma2")
        self.buttonGroup_3 = QtWidgets.QButtonGroup(Dialog)
        self.buttonGroup_3.setObjectName("buttonGroup_3")
        self.buttonGroup_3.addButton(self.radioButton_kvssigma2)
        self.verticalLayout_5.addWidget(self.radioButton_kvssigma2)
        self.radioButton_bvssigma2 = QtWidgets.QRadioButton(self.groupBox_3)
        font = QtGui.QFont()
        font.setPointSize(14)
        self.radioButton_bvssigma2.setFont(font)
        self.radioButton_bvssigma2.setObjectName("radioButton_bvssigma2")
        self.buttonGroup_3.addButton(self.radioButton_bvssigma2)
        self.verticalLayout_5.addWidget(self.radioButton_bvssigma2)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_bname.setText(_translate("Dialog", "磁场梯度∂‌B/∂‌x(T/m)"))
        self.label_k.setText(_translate("Dialog", "聚焦参数K(m⁻²)"))
        ...
        self.pushButton_calck.setText(_translate("Dialog", "计算聚焦参数"))
        self.groupBox_2.setTitle(_translate("Dialog", "计算结果"))
        self.label_5.setText(_translate("Dialog", "ε(mm mrad)"))
        self.label_6.setText(_translate("Dialog", "α"))
        self.label_7.setText(_translate("Dialog", "β"))
        self.label_8.setText(_translate("Dialog", "γ"))
        self.label_9.setText(_translate("Dialog", "εn(mm mrad)"))
        self.groupBox_3.setTitle(_translate("Dialog", "画图"))
        self.radioButton_kvssigma2.setText(_translate("Dialog", "K vs σ2"))
        self.radioButton_bvssigma2.setText(_translate("Dialog", "B vs σ2"))
